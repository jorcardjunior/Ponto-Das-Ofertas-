...
> Each variable is replaced at runtime by the orchestrator (hefaisto-master) before spawning the subagent via the Task tool.
...
|---------|-----------|-----------|-----------|
| `core` | `.hefaisto-core/development/agents/{agent}.md` | `.hefaisto-core/development/tasks/{uses}.md` | `.hefaisto-core/data/{file}` |
...
2. If not found, check `.hefaisto-core/development/agents/{agent}.md`
...
- The orchestrator (hefaisto-master) builds the prompt by reading files and replacing variables
