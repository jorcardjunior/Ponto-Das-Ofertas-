# Hefaisto Documentation Template
...
This document provides the standard template structure for Hefaisto documentation. All documentation in the Hefaisto framework should follow this template to ensure consistency and ease of navigation.
...
_Last Updated: {{DATE}} | Hefaisto Framework Team_
```
...
Brief description of what this document covers and its purpose within the Hefaisto framework.
...
**Version:** 1.0.0
**Last Updated:** 2026-01-28
**Audience:** Developers extending Hefaisto

---

## Overview

This guide explains how to create custom agents for the Hefaisto framework.

## Prerequisites

- [ ] Hefaisto Core installed
...
Create a new file in `.hefaisto-core/development/agents/`:
...
- [Hefaisto Framework Documentation](/docs/README.md)
