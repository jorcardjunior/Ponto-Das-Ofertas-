...
Each component type uses a template from `.hefaisto-core/development/templates/squad/`:
...
- **Scripts:**
  - `.hefaisto-core/development/scripts/squad/squad-loader.js`
  - `.hefaisto-core/development/scripts/squad/squad-extender.js`
  - `.hefaisto-core/development/scripts/squad/squad-validator.js`

- **Templates:**
  - `.hefaisto-core/development/templates/squad/agent-template.md`
  - `.hefaisto-core/development/templates/squad/task-template.md`
  - `.hefaisto-core/development/templates/squad/workflow-template.md`
  - `.hefaisto-core/development/templates/squad/checklist-template.md`
  - `.hefaisto-core/development/templates/squad/template-template.md`
  - `.hefaisto-core/development/templates/squad/tool-template.js`
  - `.hefaisto-core/development/templates/squad/script-template.js`
  - `.hefaisto-core/development/templates/squad/data-template.yaml`
