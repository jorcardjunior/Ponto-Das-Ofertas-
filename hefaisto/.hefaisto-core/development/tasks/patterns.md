...
pre-conditions:
  ...
  - [ ] Pattern storage exists
    tipo: pre-condition
    blocker: false
    validação: Check .hefaisto-core/data/learned-patterns.yaml exists
...
```javascript
const learning = require('.hefaisto-core/workflow-intelligence/learning');
...
Storage file: .hefaisto-core/data/learned-patterns.yaml
...
try {
  ...
  console.log('Try running: rm .hefaisto-core/data/learned-patterns.yaml');
}
```
