...
**Agent:** @hefaisto-master
**Story:** IDS-7 (hefaisto-master IDS Governor Integration)
...
```bash
node bin/hefaisto-ids.js ids:check "your intent" --type task
node bin/hefaisto-ids.js ids:impact create-doc
node bin/hefaisto-ids.js ids:stats --json
node bin/hefaisto-ids.js ids:register path/to/file.md
```
...
- `.hefaisto-core/core/ids/framework-governor.js` — FrameworkGovernor class
- `.hefaisto-core/core/ids/registry-loader.js` — RegistryLoader
- `.hefaisto-core/core/ids/incremental-decision-engine.js` — DecisionEngine
- `.hefaisto-core/core/ids/registry-updater.js` — RegistryUpdater
- `.hefaisto-core/core/ids/registry-healer.js` — RegistryHealer (optional, IDS-4a)
