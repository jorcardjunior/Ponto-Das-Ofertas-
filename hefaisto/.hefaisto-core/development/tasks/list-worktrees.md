...
Lists all Hefaisto-managed worktrees with their current status, uncommitted changes, and age. Provides visibility into parallel development activities.

**Features:**

- Shows all active worktrees managed by Hefaisto
...
**Action:** Get all Hefaisto-managed worktrees
...
[
  {
    "storyId": "STORY-42",
    "path": "/abs/path/.hefaisto/worktrees/STORY-42",
...
No Hefaisto-managed worktrees found.
...
**Resolution:** Check Hefaisto installation.
