...
const { getCodebaseOverview, getDependencyGraph } = require('.hefaisto-core/core/code-intel/helpers/planning-helper');
...
```javascript
// .hefaisto-core/core/orchestration/executor-assignment.js
const { assignExecutorFromContent } = require('.hefaisto-core/core/orchestration/executor-assignment');
