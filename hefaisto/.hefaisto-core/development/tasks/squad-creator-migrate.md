...
Migrates legacy squad formats to Hefaisto 2.1 standard.
...
| Missing `hefaisto.type` | Field not present | Add `hefaisto.type: squad` |
| Missing `hefaisto.minVersion` | Field not present | Add `hefaisto.minVersion: 2.1.0` |
...
───────────────────────────────────────────────────────────
  ...
  ❌ [ERROR] Missing required field: hefaisto.type
  ❌ [ERROR] Missing required field: hefaisto.minVersion
...
───────────────────────────────────────────────────────────
  ...
  3. Add field: hefaisto.type = "squad"
  4. Add field: hefaisto.minVersion = "2.1.0"
...
───────────────────────────────────────────────────────────
  ...
  Executed Actions:
    ...
    ✅ Add field: hefaisto.type = "squad" [success]
    ✅ Add field: hefaisto.minVersion = "2.1.0" [success]
...
───────────────────────────────────────────────────────────
  ...
  Executed Actions:
    ...
    🔍 Add field: hefaisto.type = "squad" [dry-run]
    🔍 Add field: hefaisto.minVersion = "2.1.0" [dry-run]
...
```javascript
const { SquadMigrator } = require('./.hefaisto-core/development/scripts/squad');
const { SquadValidator } = require('./.hefaisto-core/development/scripts/squad');
...
- **Schema:** .hefaisto-core/schemas/squad-schema.json
