...
- **Tool:** build-component
  ...
  - **Source:** .hefaisto-core/development/tasks/build-component.md

- **Tool:** generate-documentation
  - **Purpose:** Generate Pattern Library docs
  - **Source:** .hefaisto-core/development/tasks/generate-documentation.md
...
- **Tool:** calculate-roi
  ...
  - **Source:** .hefaisto-core/development/tasks/calculate-roi.md
  ...
  quality-pipeline:
    ...
    steps:
      ...
      - name: Run Design System Pipeline
        run: npx hefaisto-core task run-design-system-pipeline --mode=yolo
```
...
{
  "scripts": {
    "ds:pipeline": "npx hefaisto-core task run-design-system-pipeline",
    "ds:pipeline:ci": "npx hefaisto-core task run-design-system-pipeline --mode=yolo"
  }
}
```
