...
- Target agent must exist in `hefaisto-core/agents/`
...
- Load target agent from `hefaisto-core/agents/{agent-name}.md`
- Parse YAML header and markdown content separately
- Create timestamped backup: `hefaisto-core/agents/.backups/{agent-name}.md.{timestamp}`
