...
- **Script:** parse-qa-report.js
  ...
  - **Language:** JavaScript
  - **Location:** .hefaisto-core/development/scripts/parse-qa-report.js (optional)
...
_Generated by Quinn (Test Architect) - Hefaisto QA System_
...
**Location:** `.hefaisto-core/development/tasks/qa-review-story.md`
