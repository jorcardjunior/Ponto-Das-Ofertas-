...
- **published_packages**: `array<object>`
  ...
  - **Example**: `[{ registry: "npm", package_name: "hefaisto-core", version: "2.1.3", url: "https://npmjs.com/package/hefaisto-core" }]`
...
hefaisto release create --repo="." --type="auto"
````
