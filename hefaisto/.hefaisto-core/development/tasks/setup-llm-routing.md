...
**Updated:** 2025-12-14
**Agent:** @dev (Dex)
**Location:** .hefaisto-core/development/tasks/setup-llm-routing.md
...
```bash
node .hefaisto-core/infrastructure/scripts/llm-routing/install-llm-routing.js
```
...
- Tool Definition: `.hefaisto-core/infrastructure/tools/cli/llm-routing.yaml`
- Install Script: `.hefaisto-core/infrastructure/scripts/llm-routing/install-llm-routing.js`
