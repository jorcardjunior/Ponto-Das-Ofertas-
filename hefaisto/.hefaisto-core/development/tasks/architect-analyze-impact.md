...
alyze Impact - Hefaisto Developer Task

## Purpose
Analyze the potential impact of proposed component modifications on the broader Synkra Hefaisto framework.
...
*analyze-impact modify hefaisto-core/agents/weather-agent.md --depth deep --include-tests

# Analyze deprecation impact with visual output
*analyze-impact deprecate hefaisto-core/scripts/old-helper.js --output-format visual --save-report reports/deprecation-impact.html

# Quick impact check for refactoring
*analyze-impact refactor hefaisto-core/tasks/process-data.md --depth shallow --risk-threshold medium

# Analyze removal with approval workflow
*analyze-impact remove hefaisto-core/workflows/legacy-workflow.yaml --depth deep --save-report reports/removal-impact.json
```
...
class AnalyzeImpactTask {
  ...
  async execute(params) {
    try {
      console.log(chalk.blue('🔍 Hefaisto Impact Analysis'));
...
{
  "success": true,
  "targetComponent": "hefaisto-core/agents/weather-agent.md",
  "riskLevel": "medium",
