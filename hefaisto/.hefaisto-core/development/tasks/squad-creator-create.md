...
Cria um novo squad seguindo a arquitetura task-first do Hefaisto.
...
? Config inheritance:
  > extend (adiciona as regras do core)
    ...
    none (sem heranca)
? Minimum Hefaisto version: (2.1.0)
```
...
📚 Documentation:
   ...
   - Task Format: .hefaisto-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md
