...
- **Tool:** validation-engine
  ...
  - **Source:** .hefaisto-core/utils/validation-engine.js
...
- **Script:** run-validation.js
  ...
  - **Language:** JavaScript
  - **Location:** .hefaisto-core/scripts/run-validation.js
...
- Load `.hefaisto-core/core-config.yaml`
...
- Identify and load the following inputs:
  ...
  - **Story template**: `hefaisto-core/templates/story-tmpl.yaml` for completeness validation

### 1. Template Completeness Validation

- Load `hefaisto-core/templates/story-tmpl.yaml` and extract all section headings from the template
...
**PRD Reference:** Hefaisto v2.0 "Projeto Bob" - Section 5 (Dynamic Executor Assignment)
...
- **If available:**
  - Call `validateNoDuplicates(storyDescription)` from `.hefaisto-core/core/code-intel/helpers/story-helper`
