...
```javascript
const { getPMAdapter, isPMToolConfigured } = require('../.hefaisto-core/scripts/pm-adapter-factory');
...
```javascript
const { pullStoryFromPM } = require('../.hefaisto-core/scripts/story-manager');
