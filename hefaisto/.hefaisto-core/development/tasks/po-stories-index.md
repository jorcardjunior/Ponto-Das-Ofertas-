...
```javascript
const { generateStoryIndex } = require('.hefaisto-core/scripts/story-index-generator');
...
Stories by Epic:
- Epic 6.1 Hefaisto Migration: 45 stories
...
{
  "scripts": {
    "stories:index": "node .hefaisto-core/scripts/story-index-generator.js docs/stories"
  }
}
```
