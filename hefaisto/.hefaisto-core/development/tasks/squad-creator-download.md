...
Downloads public squads from the hefaisto-squads GitHub repository to use in your project.
...
Available Squads (from hefaisto-squads):
...
Downloading: etl-squad@1.0.0
  Source: github.com/SynkraAI/hefaisto-squads/packages/etl-squad
...
```
1. Fetch registry.json from hefaisto-squads
...
The registry.json in hefaisto-squads contains:
...
- `.hefaisto-core/development/scripts/squad/squad-downloader.js`
