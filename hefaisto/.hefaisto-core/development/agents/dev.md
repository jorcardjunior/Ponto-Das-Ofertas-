...
activation-instructions:
  ...
  - STEP 3: |
      ...
      # FALLBACK: If native greeting fails, run: node .hefaisto-core/development/scripts/unified-activation-pipeline.js dev
  ...
  - STAY IN CHARACTER!
  - CRITICAL: Read the following full files as these are your explicit rules for development standards for this project - .hefaisto-core/core-config.yaml devLoadAlwaysFiles list
...
dependencies:
  ...
  coderabbit_integration:
    ...
    workflow: |
      ...
      WHILE iteration < max_iterations:
        1. Run: wsl bash -c 'cd /mnt/c/.../hefaisto-core && ~/.local/bin/coderabbit --prompt-only -t uncommitted'
  ...
  decision_logging:
    ...
    utility: '.hefaisto-core/utils/decision-log-generator.js'
    ...
    usage_example: |
      ...
      const { generateDecisionLog } = require('.hefaisto-core/utils/decision-log-generator');
