...
### Project Structure
- `.hefaisto-core/core/` — Core modules (synapse, session, code-intel, orchestration)
- `.hefaisto-core/development/` — Agents, tasks, templates, scripts
- `.hefaisto-core/infrastructure/` — CI/CD, git detection, project-status
...
- atomicWriteSync from `.hefaisto-core/core/synapse/utils/atomic-write` for safe file writes
