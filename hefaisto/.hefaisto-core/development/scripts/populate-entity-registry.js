...
const SCAN_CONFIG = [
  { category: 'tasks', basePath: '.hefaisto-core/development/tasks', glob: '**/*.md', type: 'task' },
  { category: 'templates', basePath: '.hefaisto-core/product/templates', glob: '**/*.{yaml,yml,md}', type: 'template' },
  { category: 'scripts', basePath: '.hefaisto-core/development/scripts', glob: '**/*.{js,mjs}', type: 'script' },
  { category: 'modules', basePath: '.hefaisto-core/core', glob: '**/*.{js,mjs}', type: 'module' },
  { category: 'agents', basePath: '.hefaisto-core/development/agents', glob: '**/*.{md,yaml,yml}', type: 'agent' },
  { category: 'checklists', basePath: '.hefaisto-core/development/checklists', glob: '**/*.md', type: 'checklist' },
  { category: 'data', basePath: '.hefaisto-core/data', glob: '**/*.{yaml,yml,md}', type: 'data' },
  { category: 'workflows', basePath: '.hefaisto-core/development/workflows', glob: '**/*.{yaml,yml}', type: 'workflow' },
  { category: 'utils', basePath: '.hefaisto-core/core/utils', glob: '**/*.js', type: 'util' },
  { category: 'tools', basePath: '.hefaisto-core/development/tools', glob: '**/*.{md,js,sh}', type: 'tool' },
  { category: 'infra-scripts', basePath: '.hefaisto-core/infrastructure/scripts', glob: '**/*.js', type: 'script' },
  { category: 'infra-tools', basePath: '.hefaisto-core/infrastructure/tools', glob: '**/*.{yaml,yml,md}', type: 'tool' },
  { category: 'product-checklists', basePath: '.hefaisto-core/product/checklists', glob: '**/*.md', type: 'checklist' },
  { category: 'product-data', basePath: '.hefaisto-core/product/data', glob: '**/*.{yaml,yml,md}', type: 'data' }
];
...
const KNOWN_AGENTS = [
  ...
  'analyst', 'data-engineer', 'ux-design-expert', 'hefaisto-master'
];
...
function populate(options = {}) {
  const verbose = options.verbose || process.argv.includes('--verbose') || process.env.Hefaisto_DEBUG === 'true';
