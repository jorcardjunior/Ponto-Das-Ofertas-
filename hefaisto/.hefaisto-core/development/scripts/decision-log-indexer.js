 ...
 * @see .hefaisto-core/scripts/decision-recorder.js
 */
...
async function loadConfig() {
  ...
  try {
    const configContent = await fs.readFile('.hefaisto-core/core-config.yaml', 'utf8');
...
- [Core Configuration](.hefaisto-core/core-config.yaml)
...
*To manually rebuild the index, run: node .hefaisto-core/scripts/decision-log-indexer.js rebuild*
`;
