 ...
 * Workflow Validator
 *
 * Validates workflow YAML files against Hefaisto workflow conventions:
 * 1. YAML syntax
...
class WorkflowValidator {
  ...
  constructor(options = {}) {
    ...
    this.agentsPath = options.agentsPath || path.join(process.cwd(), '.hefaisto-core', 'development', 'agents');
