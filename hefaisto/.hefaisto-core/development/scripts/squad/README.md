...
Utilities for the squad-creator agent to manage squads in Hefaisto projects.
...
```javascript
const { SquadLoader } = require('./.hefaisto-core/development/scripts/squad');
...
```javascript
const { SquadLoader, SquadLoaderError } = require('./.hefaisto-core/development/scripts/squad');
...
# Run with coverage
npm test -- tests/unit/squad/squad-loader.test.js --coverage --collectCoverageFrom=".hefaisto-core/development/scripts/squad/*.js"
```
