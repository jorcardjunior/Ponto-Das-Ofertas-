/**
 * Dependency Analyzer for Hefaisto-FULLSTACK
...
class DependencyAnalyzer {
  constructor(options = {}) {
    ...
    this.manifestPath = path.join(this.rootPath, 'hefaisto-core', 'team-manifest.yaml');
    
    // Component paths
    this.paths = {
      agents: path.join(this.rootPath, 'hefaisto-core', 'agents'),
      tasks: path.join(this.rootPath, 'hefaisto-core', 'tasks'),
      workflows: path.join(this.rootPath, 'hefaisto-core', 'workflows')
    };
