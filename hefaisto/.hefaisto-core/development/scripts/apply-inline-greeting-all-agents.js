/**
 * Apply Inline Greeting Logic to All 11 Hefaisto Agents
...
const CLAUDE_AGENTS_DIR = path.join(__dirname, '..', '..', '.claude', 'commands', 'Hefaisto', 'agents');
...
function main() {
  ...
  if (results.updated > 0) {
    ...
    console.log('🔄 Files synchronized to .claude/commands/Hefaisto/agents/');
  }
}
