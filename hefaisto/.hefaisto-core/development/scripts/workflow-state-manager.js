 ...
 * New code should use: .hefaisto-core/core/orchestration/session-state.js
 *
 ...
 *
 * State files are stored at: .hefaisto/{instance-id}-state.yaml
 *
 * Design constraints:
...
class WorkflowStateManager {
  ...
  constructor(options = {}) {
    ...
    this.stateDir = path.join(this.basePath, '.hefaisto');
  }
  ...
  resolveAgentPaths(state) {
    const corePath = path.join(this.basePath, '.hefaisto-core', 'development', 'agents');
