/**
 * Backlog Manager for Hefaisto Framework
 *
...
`;
    ...
    markdown += '\n---\n\n';
    markdown += '*Auto-generated by Hefaisto Backlog Manager (Story 6.1.2.6)*\n';
    markdown += '*Update: Run `npm run stories:backlog` or `node .hefaisto-core/scripts/backlog-manager.js generate docs/stories/backlog.md`*\n';
