...
/**
 * Known Hefaisto task registry commands
 * @type {Set<string>}
 */
...
class PatternValidator {
  ...
  validate(pattern) {
    ...
    // Rule 6: All commands should exist in Hefaisto task registry
  ...
  /**
   * Check if a command is known in the Hefaisto task registry
