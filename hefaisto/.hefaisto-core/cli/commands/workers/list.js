 ...
 *
 * Implements `hefaisto workers list` CLI command.
...
function createListCommand() {
  ...
  list
    ...
    .addHelpText('after', `
Examples:
  $ hefaisto workers list
  $ hefaisto workers list --category=task
  $ hefaisto workers list --format=table
  $ hefaisto workers list --format=json --category=script
  $ hefaisto workers list --page=2 --limit=10
  $ hefaisto workers list --count
  $ hefaisto workers list --verbose
