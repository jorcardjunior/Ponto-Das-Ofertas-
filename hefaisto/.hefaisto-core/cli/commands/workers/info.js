 ...
 *
 * Implements `hefaisto workers info <id>` CLI command.
...
function createInfoCommand() {
  ...
  info
    ...
    .addHelpText('after', `
Examples:
  $ hefaisto workers info json-csv-transformer
  $ hefaisto workers info architect-checklist --format=json
  $ hefaisto workers info create-story --format=yaml
  $ hefaisto workers info data-analyzer --verbose
