...
Data Storage:
  Metrics are stored in .hefaisto/data/quality-metrics.json
...
Examples:
  $ hefaisto metrics record --layer 1 --passed --duration 3200
  $ hefaisto metrics record --layer 2 --passed --findings 3 --coderabbit
  $ hefaisto metrics show
  $ hefaisto metrics show --layer 2
  $ hefaisto metrics show --format json
  $ hefaisto metrics seed --days 30
  $ hefaisto metrics cleanup
  $ hefaisto metrics cleanup --dry-run
`);
