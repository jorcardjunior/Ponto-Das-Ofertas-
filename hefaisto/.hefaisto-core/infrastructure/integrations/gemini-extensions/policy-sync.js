...
class PolicySync {
  ...
  /**
   * Get Hefaisto permission policies
   */
  async getHefaistoPolicies() {
    const policiesPath = path.join(this.projectDir, '.hefaisto', 'policies.json');
  ...
  async exportToGemini() {
    const policies = await this.getHefaistoPolicies();
