...
Project Management tool adapters for Hefaisto. Enables story synchronization with various PM tools.
...
PM tool is configured via `.hefaisto-pm-config.yaml` in the project root:
