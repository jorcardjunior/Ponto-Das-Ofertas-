...
function loadConfig(projectRoot) {
  const configPath = path.join(projectRoot, '.hefaisto-core', 'core-config.yaml');
  ...
  const defaultConfig = {
    ...
    redirects: {
      ...
      'hefaisto-orchestrator': 'hefaisto-master',
...
function showHelp() {
  console.log(`
${colors.bright}IDE Sync${colors.reset} - Sync Hefaisto agents to IDE command files
