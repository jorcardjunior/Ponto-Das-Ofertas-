...
\`\`\``,
  ...
  async savePatterns(outputPath) {
    const defaultPath = path.join(this.rootPath, '.hefaisto', 'patterns.md');
...
`);
  ...
  // Find project root (look for package.json or .hefaisto-core)
