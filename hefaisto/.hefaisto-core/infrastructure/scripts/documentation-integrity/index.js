 ...
 *
 * Mode-aware project configuration system for Hefaisto.
...
module.exports = {
  ...
  isHefaistoCoreRepository: modeDetector.isHefaistoCoreRepository,
  ...
  hasHefaistoIntegration: gitignoreGenerator.hasHefaistoIntegration,
