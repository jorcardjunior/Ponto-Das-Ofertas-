...
/**
 * Framework structure analyzer for Synkra Hefaisto
 * Discovers and catalogs all framework components
 */
class FrameworkAnalyzer {
  constructor(options = {}) {
    this.rootPath = options.rootPath || process.cwd();
    this.hefaistoCoreDir = path.join(this.rootPath, 'hefaisto-core');
  ...
  async discoverAgents() {
    const agents = [];
    const agentsDir = path.join(this.hefaistoCoreDir, 'agents');
  ...
  async discoverTasks() {
    const tasks = [];
    const tasksDir = path.join(this.hefaistoCoreDir, 'tasks');
  ...
  async discoverWorkflows() {
    const workflows = [];
    const workflowsDir = path.join(this.hefaistoCoreDir, 'workflows');
  ...
  async discoverUtils() {
    const utils = [];
    const utilsDir = path.join(this.hefaistoCoreDir, 'utils');
  ...
  async discoverTemplates() {
    const templates = [];
    const templatesDir = path.join(this.hefaistoCoreDir, 'templates');
