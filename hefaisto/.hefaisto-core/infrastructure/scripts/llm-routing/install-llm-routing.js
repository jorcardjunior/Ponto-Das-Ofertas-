 ...
 *
 * @module llm-routing
 * @location .hefaisto-core/infrastructure/scripts/llm-routing/
 */
...
function getInstallationSummary(result) {
  ...
  if (result.success) {
    ...
    summary.push('');
    summary.push('Usage data saved to: ~/.hefaisto/usage-tracking/deepseek-usage.json');
    summary.push('');
  } else {
    summary.push('');
...
if (require.main === module) {
  console.log('\n🚀 Hefaisto LLM Routing Installer\n');
