 ...
 * - AC3: Output: `.hefaisto/codebase-map.json`
...
const CONFIG = {
  // AC3: Output path
  outputPath: '.hefaisto/codebase-map.json',
  // Schema version
  schemaVersion: '1.0',
  // Default max depth
  defaultMaxDepth: 5,
...
async function main() {
  ...
  if (args.includes('--help') || args.includes('-h')) {
    console.log(`
Codebase Mapper - Hefaisto Memory Layer (Story 7.2)
...
Commands:
  ...
  save            Save to .hefaisto/codebase-map.json
