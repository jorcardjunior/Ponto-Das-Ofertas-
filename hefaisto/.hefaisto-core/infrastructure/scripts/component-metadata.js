/**
 * Component Metadata Manager for Synkra Hefaisto
...
class ComponentMetadata {
  constructor(options = {}) {
    ...
    this.metadataPath = path.join(this.rootPath, 'hefaisto-core', 'metadata');

    // Initialize memory adapter if available
    this.memoryClient = MemoryAdapter ? new MemoryAdapter({
      persistencePath: path.join(this.rootPath, 'hefaisto-memory-layer-mvp', 'data'),
