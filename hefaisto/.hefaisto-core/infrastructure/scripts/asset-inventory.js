...
/**
 * Hefaisto Asset Inventory Generator
 * Story 2.1: Creates comprehensive inventory of all Hefaisto assets
 *
 * Usage:
...
const ASSET_PATHS = {
  ...
  templates: '.hefaisto-core/product/templates',
  checklists: '.hefaisto-core/product/checklists',
  scripts: '.hefaisto-core/infrastructure/scripts',
  schemas: '.hefaisto-core/schemas',
...
function formatConsoleOutput(report, verbose = false) {
  ...
  lines.push('');
  lines.push('═══════════════════════════════════════════════════════════');
  lines.push('  Hefaisto Asset Inventory');
...
Options:
  ...
  // Find project root (look for .hefaisto-core directory)
