 ...
 * - AC2: Generates `.hefaisto/gotchas.md` consolidated
...
const CONFIG = {
  ...
  outputJsonPath: '.hefaisto/gotchas.json',
  ...
  // Schema version
  schemaVersion: 'hefaisto-gotchas-v1',
};
...
*Generated by Hefaisto Gotchas Documenter v${CONFIG.version}*
`;
  ...
  static showHelp() {
    console.log(`
Gotchas Documenter - Hefaisto Memory Layer (Story 7.4)
