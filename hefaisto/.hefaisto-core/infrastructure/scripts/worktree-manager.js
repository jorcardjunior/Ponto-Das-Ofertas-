 ...
 * @property {string} [worktreeDir='.hefaisto/worktrees'] - Directory for worktrees
 ...
 * @property {string} [mergeLogDir='.hefaisto/logs/merges'] - Directory for merge audit logs
 */
...
class WorktreeManager {
  ...
  constructor(projectRoot, options = {}) {
    ...
    this.worktreeDir = options.worktreeDir || '.hefaisto/worktrees';
    this.branchPrefix = options.branchPrefix || 'auto-claude/';
    this.staleDays = options.staleDays || 30;
    this.mergeLogDir = options.mergeLogDir || '.hefaisto/logs/merges';
    this.gitPath = 'git';
  }
