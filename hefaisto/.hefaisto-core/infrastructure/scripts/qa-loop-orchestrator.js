...
const CONFIG = {
  ...
  // Workflow definition
  workflowPath: '.hefaisto-core/development/workflows/qa-loop.yaml',
  ...
  persistenceIndexPath: '.hefaisto/qa-loops-index.json', // Track all active loops
};
...
class QALoopOrchestrator {
  ...
  _loadMaxIterations() {
    ...
    const configPaths = [
      path.join(this.rootPath, '.hefaisto/config.yaml'),
      path.join(this.rootPath, '.hefaisto/config.yml'),
      path.join(this.rootPath, 'hefaisto.config.js'),
    ];
...
function printHelp() {
  console.log(`
📊 QA Loop Orchestrator - Hefaisto QA Evolution (Story 6.5)
