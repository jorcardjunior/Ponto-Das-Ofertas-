#!/usr/bin/env node
// =============================================================================
// Hefaisto Capability Detection Module
// =============================================================================
...
//
// Usage:
//   node .hefaisto-core/data/capability-detection.js
//
// Output:
//   .hefaisto/runtime-capabilities.json
// =============================================================================
...
const OUTPUT_PATH = path.join(PROJECT_ROOT, '.hefaisto', 'runtime-capabilities.json');
...
function loadToolRegistry() {
  const registryPath = path.join(PROJECT_ROOT, '.hefaisto-core', 'data', 'tool-registry.yaml');
  try {
