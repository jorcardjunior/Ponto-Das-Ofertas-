...
/**
 * Hefaisto Unified Statusline v3 for Claude Code
 *
 * Displays: Session | Model | Context Bar | Time | Agent | Squad | Project:Branch | Git | Messages | Alert
 *
 * Installed automatically by `npx hefaisto-core install` when no existing statusline is detected.
 * Source: .hefaisto-core/product/templates/statusline/
 */
