...
This template defines the canonical activation-instructions format for Hefaisto agents after GreetingBuilder integration (Story 6.1.2.5).
...
activation-instructions:
  ...
  - STEP 3: Build intelligent greeting using .hefaisto-core/development/scripts/greeting-builder.js
...
```yaml
- STEP 2.5: Load project status using .hefaisto-core/infrastructure/scripts/project-status-loader.js
- STEP 2.6: Load session context using .hefaisto-core/scripts/session-context-loader.js
...
- **GreetingBuilder**: `.hefaisto-core/development/scripts/greeting-builder.js`
- **Context Detector**: `.hefaisto-core/core/session/context-detector.js`
- **Git Config Detector**: `.hefaisto-core/infrastructure/scripts/git-config-detector.js`
- **Workflow Navigator**: `.hefaisto-core/development/scripts/workflow-navigator.js`
- **Project Status Loader**: `.hefaisto-core/infrastructure/scripts/project-status-loader.js`
- **Workflow Patterns**: `.hefaisto-core/data/workflow-patterns.yaml`
...
*Template maintained by Hefaisto Framework Team*
