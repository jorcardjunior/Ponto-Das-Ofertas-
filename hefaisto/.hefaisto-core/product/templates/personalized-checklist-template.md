...
2. All tests pass
3. Execute `.hefaisto-core/product/checklists/story-dod-checklist.md`
...
node .hefaisto-core/scripts/validate-checklist.js {checklist-id}
  ...
  checklist-validation:
    ...
    steps:
      ...
      - name: Generate Report
        run: |
          node .hefaisto-core/scripts/generate-checklist-report.js {checklist-id}
...
- **Standard:** `.hefaisto-core/docs/standards/AGENT-PERSONALIZATION-STANDARD-V1.md`
- **Agent File:** `.hefaisto-core/agents/{agent-id}.md`
