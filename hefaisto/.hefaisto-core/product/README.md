...
```javascript
const templatePath = '.hefaisto-core/product/templates/story-tmpl.yaml';
const checklistPath = '.hefaisto-core/product/checklists/story-dod-checklist.md';
```
...
---
*Synkra Hefaisto v4 - Product Module*
