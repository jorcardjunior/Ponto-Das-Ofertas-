# Synkra Hefaisto Constitution

> **Version:** 1.0.0 | **Ratified:** 2025-01-30 | **Last Amended:** 2025-01-30

Este documento define os princípios fundamentais e inegociáveis do Synkra Hefaisto. Todos os agentes, tasks, e workflows DEVEM respeitar estes princípios. Violações são bloqueadas automaticamente via gates.
...
- **Gates implementados em:** `.hefaisto-core/development/tasks/`
- **Checklists relacionados:** `.hefaisto-core/product/checklists/`

---

*Synkra Hefaisto Constitution v1.0.0*
