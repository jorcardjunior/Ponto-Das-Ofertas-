 ...
 *
 * Scans Hefaisto modules and builds the service registry JSON file.
...
const SCAN_SOURCES = [
  {
    pattern: '.hefaisto-core/development/tasks/**/*.md',
    category: 'task',
  ...
  {
    pattern: '.hefaisto-core/product/templates/**/*.md',
    category: 'template',
    taskFormat: 'TEMPLATE',
    subcategoryExtractor: (filePath) => {
  ...
  {
    pattern: '.hefaisto-core/infrastructure/scripts/**/*.js',
    category: 'script',
    taskFormat: 'SCRIPT',
    subcategoryExtractor: (filePath) => {
  ...
  {
    pattern: '.hefaisto-core/product/checklists/**/*.md',
    category: 'checklist',
    taskFormat: 'CHECKLIST',
    subcategoryExtractor: () => 'quality',
  },
  {
    pattern: '.hefaisto-core/development/workflows/**/*.yaml',
    category: 'workflow',
    taskFormat: 'WORKFLOW',
    subcategoryExtractor: (filePath) => {
  ...
  {
    pattern: '.hefaisto-core/core/data/**/*.md',
    category: 'data',
    taskFormat: 'TASK-FORMAT-V1',
    subcategoryExtractor: () => 'knowledge',
  },
  {
    pattern: '.hefaisto-core/core/data/**/*.yaml',
    category: 'data',
    taskFormat: 'TASK-FORMAT-V1',
...
async function main() {
  ...
  const outputPath = process.argv[3] || path.join(baseDir, '.hefaisto-core/core/registry/service-registry.json');
