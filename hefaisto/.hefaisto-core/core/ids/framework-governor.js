 ...
 *
 * Facade class that integrates hefaisto-master with the IDS Entity Registry for
 ...
 *   const { IncrementalDecisionEngine } = require('.hefaisto-core/core/ids/incremental-decision-engine');
 *   const { RegistryUpdater } = require('.hefaisto-core/core/ids/registry-updater');
 *   const { FrameworkGovernor } = require('.hefaisto-core/core/ids/framework-governor');
 *
  ...
  async postRegister(filePath, metadata = {}) {
    ...
    return this._withTimeout(async () => {
      const task = {
        ...
        agent: metadata.agent || 'hefaisto-master',
