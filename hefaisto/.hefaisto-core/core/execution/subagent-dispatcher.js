...
class SubagentDispatcher extends EventEmitter {
  ...
  async getProjectContext() {
    // This would read from .hefaisto/codebase-map.json or similar
    return {
      rootPath: this.rootPath,
      framework: 'hefaisto-core',
  ...
  buildPrompt(agentId, task, context) {
    let prompt = `You are ${agentId}, a specialized agent in the Hefaisto framework.\n\n`;
