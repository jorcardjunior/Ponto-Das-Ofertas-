 ...
 * Inspired by Auto-Claude's Coder Agent but with Hefaisto extensibility.
 *
 * Features:
 * - AC1: Located in `.hefaisto-core/core/execution/`
...
async function main() {
  ...
  if (args.length === 0 || args.includes('--help') || args.includes('-h')) {
    console.log(`
${chalk.bold('Autonomous Build Loop')} - Hefaisto Coder Agent Loop (Story 8.1)
