 ...
 *
 * Reads .hefaisto-core/constitution.md and generates .synapse/constitution
 * in KEY=VALUE format for the SYNAPSE Context Engine L0 layer.
 *
 * Usage: node .hefaisto-core/core/synapse/scripts/generate-constitution.js
 *
...
function generateConstitution(articles) {
  const lines = [
    ...
    '# Auto-generated from .hefaisto-core/constitution.md',
...
function main(options = {}) {
  ...
  const constitutionPath = options.constitutionPath || path.join(projectRoot, '.hefaisto-core', 'constitution.md');
