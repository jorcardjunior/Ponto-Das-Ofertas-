...
class SubagentPromptBuilder {
  ...
  constructor(projectRoot) {
    ...
    this.hefaistoCoreRoot = path.join(projectRoot, '.hefaisto-core');

    // Paths to Hefaisto components
    this.paths = {
      agents: path.join(this.hefaistoCoreRoot, 'development', 'agents'),
      tasks: path.join(this.hefaistoCoreRoot, 'development', 'tasks'),
      checklists: path.join(this.hefaistoCoreRoot, 'product', 'checklists'),
      templates: path.join(this.hefaistoCoreRoot, 'product', 'templates'),
    };
  }
