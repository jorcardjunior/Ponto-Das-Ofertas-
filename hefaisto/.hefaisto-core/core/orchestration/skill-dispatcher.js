/**
 * Skill Dispatcher - Dispatches to Hefaisto Skills instead of generic Task calls
 *
 ...
 *
 * Responsibilities:
 * - Map agent IDs to Hefaisto Skill names
 ...
 * @property {string} skill - Full skill name (e.g., 'Hefaisto:agents:architect')
...
/**
 * Dispatches workflow phases to Hefaisto Skills
 */
/**
...
class SkillDispatcher {
  ...
  constructor(options = {}) {
     ...
     * These correspond to files in .claude/commands/Hefaisto/agents/
     */
    this.skillMapping = {
      // Core development agents
      architect: 'Hefaisto:agents:architect',
      'data-engineer': 'Hefaisto:agents:data-engineer',
      dev: 'Hefaisto:agents:dev',
      qa: 'Hefaisto:agents:qa',

      // Product agents
      pm: 'Hefaisto:agents:pm',
      po: 'Hefaisto:agents:po',
      sm: 'Hefaisto:agents:sm',
      analyst: 'Hefaisto:agents:analyst',

      // Specialized agents
      'ux-design-expert': 'Hefaisto:agents:ux-design-expert',
      'ux-expert': 'Hefaisto:agents:ux-design-expert', // Alias
      devops: 'Hefaisto:agents:devops',
      'github-devops': 'Hefaisto:agents:devops', // Alias

      // Master agent
      'hefaisto-master': 'Hefaisto:agents:hefaisto-master',
    };
    ...
    this.agentPersonas = {
      ...
      'hefaisto-master': { name: 'Orion', title: 'Master Orchestrator' },
    };
  }
   ...
   * @returns {string} Full skill name (e.g., 'Hefaisto:agents:architect')
   */
  getSkillName(agentId) {
    return this.skillMapping[agentId] || `Hefaisto:agents:${agentId}`;
  }
  ...
  getAgentPersona(agentId) {
    return (
      this.agentPersonas[agentId] || { name: agentId, title: 'Hefaisto Agent' }
    );
  }
  ...
  isValidAgent(agentId) {
    return agentId in this.skillMapping || agentId.startsWith('Hefaisto:');
  }
}
