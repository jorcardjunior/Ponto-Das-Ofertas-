...
/**
 * Get global Hefaisto directory path
 * @returns {string} Path to ~/.hefaisto/
 */
function getGlobalHefaistoDir() {
  return path.join(getHomeDir(), '.hefaisto');
}

/**
 * Get global MCP directory path
 * @returns {string} Path to ~/.hefaisto/mcp/
 */
function getGlobalMcpDir() {
  return path.join(getGlobalHefaistoDir(), 'mcp');
}

/**
 * Get global MCP config file path
 * @returns {string} Path to ~/.hefaisto/mcp/global-config.json
 */
 ...
 * @returns {string} Path to ~/.hefaisto/mcp/servers/
 */
 ...
 * @returns {string} Path to ~/.hefaisto/mcp/cache/
 */
 ...
 * @returns {string} Path to ~/.hefaisto/credentials/
 */
function getCredentialsDir() {
  return path.join(getGlobalHefaistoDir(), 'credentials');
}
