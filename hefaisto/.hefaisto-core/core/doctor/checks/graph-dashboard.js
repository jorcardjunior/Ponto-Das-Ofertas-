 ...
 *
 * Validates .hefaisto-core/core/graph-dashboard/ directory exists
 * with at least 1 .js file.
 *
 * @module hefaisto-core/doctor/checks/graph-dashboard
 * @story INS-4.1
 */
...
async function run(context) {
  const dashboardDir = path.join(context.projectRoot, '.hefaisto-core', 'core', 'graph-dashboard');
