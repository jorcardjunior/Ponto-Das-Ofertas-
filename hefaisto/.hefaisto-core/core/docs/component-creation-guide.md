...
This guide walks you through creating components in Synkra Hefaisto using the meta-agent's enhanced template system and interactive workflows.
...
1. **Check component examples**: `hefaisto-core/agents/examples/`
2. **Review templates**: `hefaisto-core/templates/`
...
Create custom templates in `hefaisto-core/templates/custom/`:
