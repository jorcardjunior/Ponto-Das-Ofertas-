 ...
 *
 * Hefaisto Config Loader with Lazy Loading
 *
...
const agentRequirements = {
  ...
  'hefaisto-master': ['frameworkDocsLocation', 'projectDocsLocation', 'devLoadAlwaysFiles', 'lazyLoading', 'registry', 'expansionPacks', 'toolConfigurations'],
...
async function loadFullConfig() {
  const configPath = path.join('.hefaisto-core', 'core-config.yaml');
