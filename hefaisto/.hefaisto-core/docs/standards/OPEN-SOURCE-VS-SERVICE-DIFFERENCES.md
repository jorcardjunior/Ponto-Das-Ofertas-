...
**Version:** 2.1.0
**Date:** 2025-12-09
**Purpose:** Document differences between Hefaisto open-source and Hefaisto service implementations
...
Hefaisto has two deployment contexts:
...
|------------|---------|------|----------|
| `SynkraAI/hefaisto-core` | Commons Clause | Public | Core framework, 11 agents, Quality Gates |
| `SynkraAI/hefaisto-squads` | MIT | Public | ETL, Creator, MMOS-Mapper squads |
...
|---------|----------|--------------|
| `@hefaisto/core` | npm public | Open-source |
| `@hefaisto/squad-etl` | npm public | Open-source |
| `@hefaisto/squad-creator` | npm public | Open-source |
| `@hefaisto/squad-mmos` | npm public | Open-source |
| `@hefaisto/mcp-presets` | npm public | Open-source |
...
│                                                                         │
│   SynkraAI/hefaisto-core        SynkraAI/hefaisto-squads                   │
│   ┌─────────────────────┐     ┌─────────────────────┐                  │
...
```yaml
**Template:**
- path: .hefaisto-core/templates/task-execution-report.md
  type: output
  version: 1.0
...
**Difference:**
- Open-source uses templates from `.hefaisto-core/templates/`
...
.hefaisto-core/checklists/{agent-id}-general-validation.md
```
...
- `.hefaisto-core/scripts/{agent-id}-specific/{script}.js`
...
**Scripts:**
- .hefaisto-core/scripts/dev-specific/test-runner.js:    # Only dev uses this
...
- Missing template → Use generic template from `.hefaisto-core/templates/`
...
- fallback: |
    ...
    1. Check .hefaisto-core/templates/ for generic version
...
**Agent Personas:**
- Defined in `.hefaisto-core/agents/{agent-id}.md`
...
- [ ] Update template paths (squads/ → .hefaisto-core/templates)
...
| **Templates** | .hefaisto-core/templates/ | squads/{squad}/ |
...
- [Hefaisto-LIVRO-DE-OURO-V2.1-COMPLETE.md](./Hefaisto-LIVRO-DE-OURO-V2.1-COMPLETE.md) - Complete v4.2 framework guide
