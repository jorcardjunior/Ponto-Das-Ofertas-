# Hefaisto Standards Documentation Index
...
1. **Start Here:** Read [Hefaisto-LIVRO-DE-OURO-V2.1-COMPLETE.md](./Hefaisto-LIVRO-DE-OURO-V2.1-COMPLETE.md) - Complete framework guide
...
- **v2.0 → v4.0.4 Migration:** See "What's New" section in [Hefaisto-LIVRO-DE-OURO-V2.1-COMPLETE.md](./Hefaisto-LIVRO-DE-OURO-V2.1-COMPLETE.md)
...
|----------|-------------|--------|---------|
| [Hefaisto-LIVRO-DE-OURO-V2.1-COMPLETE.md](./Hefaisto-LIVRO-DE-OURO-V2.1-COMPLETE.md) | **Complete v4.2 framework guide** | ✅ Current | 2.1.0 |
...
| Document | Description | Status | Version |
|----------|-------------|--------|---------|
| [Hefaisto-COLOR-PALETTE-V2.1.md](./Hefaisto-COLOR-PALETTE-V2.1.md) | Complete color system | ✅ Current | 2.1.0 |
| [Hefaisto-COLOR-PALETTE-QUICK-REFERENCE.md](./Hefaisto-COLOR-PALETTE-QUICK-REFERENCE.md) | Quick color reference | ✅ Current | 2.1.0 |

### Legacy Documents (Reference Only)

| Document | Description | Status | Superseded By |
|----------|-------------|--------|---------------|
| [Hefaisto-LIVRO-DE-OURO.md](./Hefaisto-LIVRO-DE-OURO.md) | v2.0.0 base document | ⚠️ Deprecated | Hefaisto-LIVRO-DE-OURO-V2.1-COMPLETE.md |
| [Hefaisto-LIVRO-DE-OURO-V2.1.md](./Hefaisto-LIVRO-DE-OURO-V2.1.md) | v4.0.4 delta (partial) | ⚠️ Deprecated | Hefaisto-LIVRO-DE-OURO-V2.1-COMPLETE.md |
| [Hefaisto-LIVRO-DE-OURO-V2.1-SUMMARY.md](./Hefaisto-LIVRO-DE-OURO-V2.1-SUMMARY.md) | v4.0.4 summary | ⚠️ Deprecated | Hefaisto-LIVRO-DE-OURO-V2.1-COMPLETE.md |
| [Hefaisto-LIVRO-DE-OURO-V2.2-SUMMARY.md](./Hefaisto-LIVRO-DE-OURO-V2.2-SUMMARY.md) | Future v2.2 planning | 📋 Draft | N/A |
| [Hefaisto-FRAMEWORK-MASTER.md](./Hefaisto-FRAMEWORK-MASTER.md) | v2.0.0 framework doc | ⚠️ Deprecated | Hefaisto-LIVRO-DE-OURO-V2.1-COMPLETE.md |
...
| Document | Purpose |
|----------|---------|
| Hefaisto-LIVRO-DE-OURO-V2.1-COMPLETE.md | Consolidated v4.2 documentation |
...
| @expansion/* | **@hefaisto/squad-*** | npm scope |
...
|---------|-------------|---------------|
| Modular Architecture | 4 modules (core, development, product, infrastructure) | Hefaisto-LIVRO-DE-OURO-V2.1-COMPLETE |
| Multi-Repo Strategy | 3 public + 2 private repos | Hefaisto-LIVRO-DE-OURO-V2.1-COMPLETE |
...
| npm Scoping | @hefaisto/core, @hefaisto/squad-* | Hefaisto-LIVRO-DE-OURO-V2.1-COMPLETE |
...
```
.hefaisto-core/docs/standards/
├── STANDARDS-INDEX.md                     # This file - navigation
│
├── Current v4.2 Standards
│   ├── Hefaisto-LIVRO-DE-OURO-V2.1-COMPLETE.md  # Complete v4.2 guide
...
│   ├── Hefaisto-COLOR-PALETTE-V2.1.md           # Color system
│   └── Hefaisto-COLOR-PALETTE-QUICK-REFERENCE.md
│
├── Legacy (Reference Only)
│   ├── Hefaisto-LIVRO-DE-OURO.md              # v2.0.0 base (deprecated)
│   ├── Hefaisto-LIVRO-DE-OURO-V2.1.md         # v4.0.4 delta (deprecated)
│   ├── Hefaisto-LIVRO-DE-OURO-V2.1-SUMMARY.md # v4.0.4 summary (deprecated)
│   ├── Hefaisto-FRAMEWORK-MASTER.md           # v2.0.0 (deprecated)
...
│
└── Future Planning
    └── Hefaisto-LIVRO-DE-OURO-V2.2-SUMMARY.md    # v2.2 draft
```
...
find .hefaisto-core/docs/standards -name "*.md" -exec markdown-link-check {} \;

# Search for deprecated terminology
grep -r "squad" .hefaisto-core/docs/standards --include="*.md"
grep -r "Squad" .hefaisto-core/docs/standards --include="*.md"

# Verify version numbers
grep -r "v2.0" .hefaisto-core/docs/standards --include="*.md"
```
