# Hefaisto Framework - Livro de Ouro v4.2 (Complete)
...
**Mantido Por:** Hefaisto Framework Team + Community
**Repositório Principal:** `SynkraAI/hefaisto-core`

---

> **"Structure is Sacred. Tone is Flexible."**
> _— Fundamento filosófico do Hefaisto_
...
- ✅ **npm Package Scoping** (@hefaisto/core, @hefaisto/squad-\*, @hefaisto/mcp-presets)

**Referências Legadas:**

- `Hefaisto-LIVRO-DE-OURO.md` - Base v2.0.0 (Jan 2025)
- `Hefaisto-LIVRO-DE-OURO-V2.1.md` - Delta parcial
- `Hefaisto-LIVRO-DE-OURO-V2.1-SUMMARY.md` - Resumo de mudanças
...
│                                                                         │
│   ┌────────────────────────────────────────────────────────────────┐   │
│   │  SynkraAI/hefaisto-core (Commons Clause)                         │   │
│   │  ─────────────────────────────────────                         │   │
...
| **Hefaisto v4.2** | ✅ **Complete**          | ✅ **Clones (DNA Mental™)** ⭐ |

**Analogia:** Linux é open source, mas Red Hat Enterprise Linux adiciona suporte e otimizações. Ambos são Linux, mas o valor agregado varia. Hefaisto funciona igual.
...
- 📋 **Layer 3: USAGE GUIDE** - Como usar Hefaisto v4.2 no seu contexto
...
## Bem-vindo ao Hefaisto v4.2 - Vamos Encontrar Seu Caminho
...
## Essay 1: Por Que Hefaisto Existe
...
Hefaisto fornece **orquestração estruturada**:
...
| **Pax**   | `hefaisto-master`   | Orchestrator | Framework orchestration |
...
@hefaisto-master     # Ativa Pax (Orchestrator)
...
|---------|----------|------------|---------|
| `@hefaisto/core` | npm public | - | Commons Clause |
| `@hefaisto/squad-etl` | npm public | @hefaisto/core | MIT |
| `@hefaisto/squad-creator` | npm public | @hefaisto/core | MIT |
| `@hefaisto/squad-mmos` | npm public | @hefaisto/core | MIT |
| `@hefaisto/mcp-presets` | npm public | - | Apache 2.0 |

### Installation

```bash
# Core framework
npm install @hefaisto/core

# Squads (require core as peer)
npm install @hefaisto/squad-etl

# MCP presets (independent)
npm install @hefaisto/mcp-presets
````
...
$ npx @SynkraAI/hefaisto@latest init

# Existing project (Brownfield)
$ npx @SynkraAI/hefaisto migrate v2.0-to-v4.0.4
```
...
$ hefaisto agents list

# List available Squads
$ hefaisto squads list

# Create your first story
$ hefaisto stories create

# Execute a task
$ hefaisto task develop-story --story=1.1
```
...
```bash
# Clone all repos
mkdir -p ~/Workspaces/Hefaisto && cd ~/Workspaces/Hefaisto
gh repo clone SynkraAI/hefaisto-core
gh repo clone SynkraAI/hefaisto-squads
gh repo clone SynkraAI/mcp-ecosystem

# Link for local development
cd hefaisto-core && npm install && npm link
cd ../hefaisto-squads && npm install && npm link @hefaisto/core

# VS Code workspace
code hefaisto-workspace.code-workspace
```
...
```bash
# Search for workers
$ hefaisto workers search "json parse"
...
# Get worker details
$ hefaisto workers info json-parser

# Use worker in task
$ hefaisto workers use json-parser --task my-task
```
...
| `brownfield-integration` | Add Hefaisto to existing    | dev, architect    |
...
```bash
# Start workflow
$ hefaisto workflow greenfield-fullstack

# With parameters
$ hefaisto workflow brownfield-integration --target=./existing-project
```
...
**Mantido Por:** Hefaisto Framework Team

---

_Este documento consolida Hefaisto-LIVRO-DE-OURO.md (v2.0) + deltas v4.0.4 em um único documento completo._
