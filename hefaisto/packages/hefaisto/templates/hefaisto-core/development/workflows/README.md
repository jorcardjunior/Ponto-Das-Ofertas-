...
This directory contains workflow definitions for the Synkra Hefaisto framework. Workflows define multi-step processes that can be executed by Hefaisto agents.
...
The `setup-environment` workflow helps developers configure their IDE for optimal Hefaisto development experience.

### Features
- Backs up existing IDE configurations
- Applies Hefaisto-specific development rules
- Verifies GitHub CLI installation and authentication
- Provides clear feedback throughout the process

### Usage

From the hefaisto-master agent:
```
@hefaisto-master
*setup-environment
```
...
4. **Rule Application** - Copies Hefaisto-specific rules to appropriate locations
