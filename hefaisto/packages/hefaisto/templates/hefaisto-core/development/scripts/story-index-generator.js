/**
 * Story Index Generator for Hefaisto Framework
 *
...
`;
  ...
  markdown += '\n---\n\n';
  markdown += '*Auto-generated by Hefaisto Story Index Generator (Story 6.1.2.6)*\n';
  markdown += '*Update: Run `npm run stories:index` or `node .hefaisto-core/scripts/story-index-generator.js docs/stories`*\n';
