/**
 * Transaction Manager for Hefaisto-FULLSTACK
...
class TransactionManager {
  constructor(options = {}) {
    ...
    this.transactionPath = path.join(this.rootPath, 'hefaisto-core', 'transactions');
    this.backupPath = path.join(this.rootPath, 'hefaisto-core', 'backups');
  ...
  async rollbackManifestUpdate(operation, results) {
    try {
      const manifestPath = path.join(this.rootPath, 'hefaisto-core', 'team-manifest.yaml');
