 ...
 *
 * Analyzes all 13 Hefaisto agents to determine which core-config.yaml sections
...
async function extractAgentDependencies(agentId) {
  const agentPath = path.join('.hefaisto-core', 'agents', `${agentId}.md`);
...
function analyzeConfigNeeds(agentData) {
  ...
  if (agentData.agentId === 'hefaisto-master' ||
...
*Auto-generated by Hefaisto Agent Config Audit (Story 6.1.2.6)*
`;
...
async function auditAllAgents() {
  console.log('🔍 Auditing all 13 Hefaisto agents...\n');
