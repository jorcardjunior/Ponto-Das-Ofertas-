 ...
 *
 * Usage:
 *   node .hefaisto-core/utils/validate-filenames.js
 *   node .hefaisto-core/utils/validate-filenames.js --fix
 */
...
class FilenameValidator {
  ...
  report() {
    console.log('\n📋 Hefaisto Filename Validation Report\n');
    ...
    if (this.errors.length > 0) {
      ...
      console.log('3. Or run: node .hefaisto-core/utils/validate-filenames.js --fix\n');
