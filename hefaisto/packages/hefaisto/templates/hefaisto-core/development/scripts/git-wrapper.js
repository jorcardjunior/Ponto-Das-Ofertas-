...
/**
 * Git operations wrapper for Hefaisto framework modifications
 */
class GitWrapper {
  constructor(options = {}) {
  ...
  async commit(message, options = {}) {
    const {
      author = 'hefaisto-developer <hefaisto-developer@hefaisto-fullstack.local>',
      signoff = true
    } = options;
  ...
  async commitModification(files, message, metadata = {}) {
    ...
    fullMessage += '\n\nGenerated by: hefaisto-developer meta-agent';
