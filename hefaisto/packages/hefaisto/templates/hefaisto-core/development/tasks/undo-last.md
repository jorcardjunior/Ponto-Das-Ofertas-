...
- **Tool:** backup-manager
  ...
  - **Source:** .hefaisto-core/utils/backup-manager.js
...
- **Script:** rollback-changes.js
  ...
  - **Language:** JavaScript
  - **Location:** .hefaisto-core/scripts/rollback-changes.js
...
Rollback the last component creation or modification operation. This task allows undoing recent changes made by the hefaisto-developer agent, including single component creation, batch creation, or component updates.
...
Operations:
  - Created: /hefaisto-core/agents/data-analyst.md
  - Updated: /hefaisto-core/team-manifest.yaml
  - Created: /hefaisto-core/tasks/analyze-data.md
```
