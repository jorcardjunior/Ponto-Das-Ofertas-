...
2. Call `getReferenceImpact(files)` from `.hefaisto-core/core/code-intel/helpers/qa-helper.js`
...
- Create directory defined in `qa.qaLocation/gates` (see `.hefaisto-core/core-config.yaml`) if missing
