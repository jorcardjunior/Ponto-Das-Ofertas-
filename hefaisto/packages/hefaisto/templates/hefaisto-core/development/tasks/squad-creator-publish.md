...
Publishes a local squad to the hefaisto-squads GitHub repository via Pull Request.
...
PR Preview:
  ...
  Target: SynkraAI/hefaisto-squads
...
Publishing: my-squad@1.0.0
  ...
  Target: github.com/SynkraAI/hefaisto-squads
...
Pull Request Created!
  URL: https://github.com/SynkraAI/hefaisto-squads/pull/42
  Branch: squad/my-squad
...
4. Create/check fork
   └── Fork SynkraAI/hefaisto-squads if needed
...
- `.hefaisto-core/development/scripts/squad/squad-publisher.js`
