...
required:
  ...
  - story_path: `hefaisto-core/core-config.yaml` for the `devStoryLocation`

optional:
  - architecture_refs: `hefaisto-core/core-config.yaml` for the `architecture.architectureFile`
  - technical_preferences: `hefaisto-core/core-config.yaml` for the `technicalPreferences`
