...
- Target task must exist in `hefaisto-core/tasks/`
...
- Load target task from `hefaisto-core/tasks/{task-name}.md`
- Create timestamped backup: `hefaisto-core/tasks/.backups/{task-name}.md.{timestamp}`
