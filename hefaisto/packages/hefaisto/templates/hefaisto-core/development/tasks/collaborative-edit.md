...
# Collaborative Edit - Hefaisto Developer Task
...
*collaborative-edit start --component hefaisto-core/agents/data-agent.md --participants alice,bob --mode live
...
class CollaborativeEditTask extends EventEmitter {
  constructor() {
    ...
    this.sessionDir = path.join(this.rootPath, '.hefaisto', 'sessions');
  ...
  async execute(params) {
    try {
      console.log(chalk.blue('👥 Hefaisto Collaborative Editing'));
