...
- **topic**: `string`
  ...
  - **Example**: "How can we improve user onboarding for Hefaisto?"
...
```bash
hefaisto activate Maestro
hefaisto brainstorm "How can we improve Hefaisto user onboarding for non-technical users?"
```
...
```bash
hefaisto brainstorm "How to reduce API latency in database queries?" \
...
```bash
hefaisto brainstorm "What should be our open-source expansion strategy for Q1 2026?" \
