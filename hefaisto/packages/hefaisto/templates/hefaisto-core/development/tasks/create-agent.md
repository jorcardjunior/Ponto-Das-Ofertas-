...
**Quality Standard:** Hefaisto Level (300+ lines, voice_dna, output_examples, command_loader, task files)
...
generate_agent:
  ...
  required_sections:
    # Level 1: Identity
    activation_notice: 'Standard Hefaisto header'
...
## Integration with Hefaisto

This task creates agents that:

- Follow Hefaisto agent definition standards (6 levels)
