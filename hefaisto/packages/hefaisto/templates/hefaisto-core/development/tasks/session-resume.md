...
```javascript
const { loadSessionState } = require('.hefaisto-core/core/orchestration');
...
```javascript
const { SessionState } = require('.hefaisto-core/core/orchestration');
...
```javascript
const { ResumeOption } = require('.hefaisto-core/core/orchestration');
