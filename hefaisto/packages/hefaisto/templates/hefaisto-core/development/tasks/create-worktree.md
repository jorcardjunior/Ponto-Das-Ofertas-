...
pre-conditions:
  ...
  - [ ] WorktreeManager is available
    tipo: pre-condition
    blocker: true
    validação: Script exists at .hefaisto-core/infrastructure/scripts/worktree-manager.js
    error_message: "WorktreeManager not found. Ensure Hefaisto is properly installed."
...
post-conditions:
  - [ ] Worktree directory exists
    tipo: post-condition
    blocker: true
    validação: Directory exists at .hefaisto/worktrees/{storyId}
...
- **Tool:** WorktreeManager
  ...
  - **Source:** .hefaisto-core/infrastructure/scripts/worktree-manager.js
...
```javascript
const WorktreeManager = require('./.hefaisto-core/infrastructure/scripts/worktree-manager.js');
...
⚠️  Worktree for '{storyId}' already exists.
    Path: .hefaisto/worktrees/{storyId}
...
- Directory: `.hefaisto/worktrees/{storyId}/`
- Branch: `auto-claude/{storyId}`
...
Next Steps:
  • cd .hefaisto/worktrees/{storyId}  - Navigate to worktree
...
interface WorktreeInfo {
  ...
  path: string; // '/abs/path/.hefaisto/worktrees/STORY-42'
...
- `.hefaisto/worktrees/{storyId}/` - Isolated worktree directory
...
```bash
git worktree remove .hefaisto/worktrees/{storyId}
...
- `.hefaisto-core/infrastructure/scripts/worktree-manager.js` - Core manager
...
- **Script:** `.hefaisto-core/infrastructure/scripts/worktree-manager.js`
