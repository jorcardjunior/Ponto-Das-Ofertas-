...
- **Tool:** query-validator
  ...
  - **Source:** .hefaisto-core/utils/db-query-validator.js
...
- **Script:** db-query.js
  ...
  - **Language:** JavaScript
  - **Location:** .hefaisto-core/scripts/db-query.js
...
3. `.hefaisto-core/product/templates/tmpl-smoke-test.sql` (template)
...
elif [ -f ".hefaisto-core/product/templates/tmpl-smoke-test.sql" ]; then
  SMOKE_TEST=".hefaisto-core/product/templates/tmpl-smoke-test.sql"
else
