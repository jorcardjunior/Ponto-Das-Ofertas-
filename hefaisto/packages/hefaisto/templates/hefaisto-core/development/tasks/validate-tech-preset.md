...
atomic_layer: task
Entrada: |
  - preset_path: Path to the tech preset file (default: .hefaisto-core/data/tech-presets/)
...
1. Resolve preset path
   ...
   ├── If name provided → resolve via .hefaisto-core/data/tech-presets/{name}.md
...
- Preset: .hefaisto-core/data/tech-presets/{name}.md
```

## Related

- **Agent:** @architect (Aria)
- **Location:** .hefaisto-core/data/tech-presets/
