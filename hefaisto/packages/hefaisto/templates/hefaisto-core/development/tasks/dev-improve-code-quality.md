...
# Improve Code Quality - Hefaisto Developer Task
...
*improve-code-quality hefaisto-core/scripts/legacy-utility.js --preview

# Auto-fix all safe improvements in directory
*improve-code-quality hefaisto-core/agents --auto-fix --recursive

# Apply specific patterns
*improve-code-quality hefaisto-core/utils --patterns formatting,modern-syntax,async-await

# Generate improvement report
*improve-code-quality . --recursive --report quality-report.json

# Use custom configuration
*improve-code-quality hefaisto-core --config .hefaisto/quality-config.json
```
...
class ImproveCodeQualityTask {
  ...
  async execute(params) {
    try {
      console.log(chalk.blue('🎨 Hefaisto Code Quality Improvement'));
  ...
  async createBackup(filePath) {
    const backupDir = path.join(this.rootPath, '.hefaisto', 'backups', 'code-quality');
