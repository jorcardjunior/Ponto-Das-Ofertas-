...
autoClaude:
  ...
  verification:
    type: script
    script: .hefaisto-core/infrastructure/scripts/subtask-verifier.js
    timeout: 120
```
  ...
  actions:
    - action: find_implementation
      paths:
        ...
        - .hefaisto/plans/{storyId}/implementation.yaml
...
step_2:
  actions:
    - action: execute_script
      script: |
        node .hefaisto-core/infrastructure/scripts/subtask-verifier.js {subtaskId} \
