...
pre-conditions:
  ...
  - [ ] Brownfield Analyzer module is available
    ...
    blocker: true
    validation: |
      Verify .hefaisto-core/infrastructure/scripts/documentation-integrity/brownfield-analyzer.js exists
...
- **Tool:** brownfield-analyzer
  ...
  - **Source:** .hefaisto-core/infrastructure/scripts/documentation-integrity/brownfield-analyzer.js

- **Tool:** mode-detector
  - **Purpose:** Collect project markers for analysis
  - **Source:** .hefaisto-core/infrastructure/scripts/documentation-integrity/mode-detector.js
...
- **Script:** brownfield-analyzer.js
  ...
  - **Language:** JavaScript
  - **Location:** .hefaisto-core/infrastructure/scripts/documentation-integrity/brownfield-analyzer.js
...
Analyze an existing project to understand its structure, tech stack, coding standards, and CI/CD workflows before Hefaisto integration. This task provides recommendations for safe integration and identifies potential conflicts.
...
```javascript
const { analyzeProject, formatMigrationReport } = require('./.hefaisto-core/infrastructure/scripts/documentation-integrity/brownfield-analyzer');
...
╠══════════════════════════════════════════════════════════════════════╣
║                                                                      ║
║  • Preserve existing ESLint configuration - Hefaisto will adapt          ║
║  • Keep existing Prettier settings - Hefaisto coding-standards.md will d ║
║  • Review existing CI/CD before adding Hefaisto workflows                ║
║  • Hefaisto will use existing tsconfig.json settings                     ║
...
|----------|---------|---------|
| `parallel` | Safe to proceed with standard Hefaisto setup | Use `*setup-project-docs` directly |
...
1. **Review GitHub Workflows:**
   ...
   # Check for potential conflicts with Hefaisto workflows
...
1. **docs/architecture/ exists:**
   - Decide: Keep existing or merge with Hefaisto docs
   - Option A: Rename existing to `docs/legacy-architecture/`
   - Option B: Configure Hefaisto to use alternate path
...
- Run this task BEFORE any Hefaisto integration
