...
activation-instructions:
  ...
  - STEP 3: |
      ...
      # FALLBACK: If native greeting fails, run: node .hefaisto-core/development/scripts/unified-activation-pipeline.js po
...
command_availability:
  sync-story:
    ...
    description: |
      ...
      If no PM tool configured, runs `hefaisto init` prompt
  pull-story:
    always_available: true
    description: |
...
- For course corrections → Escalate to `@hefaisto-master *correct-course`
...
3. Story templates available in `.hefaisto-core/product/templates/`
