...
/**
 * Hefaisto Agent Migration Script (V2 → V3)
...
// Paths
const AGENTS_DIR = '.hefaisto-core/development/agents';
const BACKUP_DIR = '.hefaisto/migration-backup';
const SCHEMAS_DIR = '.hefaisto-core/schemas';
...
function formatListOutput(agents) {
  ...
  lines.push('');
  lines.push('═══════════════════════════════════════════════════════════');
  lines.push('  Hefaisto Agents - Migration Status');
  lines.push('═══════════════════════════════════════════════════════════');
  lines.push('');
