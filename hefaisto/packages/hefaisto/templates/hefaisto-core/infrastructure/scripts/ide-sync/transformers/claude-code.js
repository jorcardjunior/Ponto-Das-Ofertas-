 ...
 * Target: .claude/commands/Hefaisto/agents/*.md
 */
...
function transform(agentData) {
  ...
  if (agentData.raw) {
    ...
    const syncFooter = `\n---\n*Hefaisto Agent - Synced from .hefaisto-core/development/agents/${agentData.filename}*\n`;

    if (!agentData.raw.includes('Synced from .hefaisto-core/development/agents/')) {
