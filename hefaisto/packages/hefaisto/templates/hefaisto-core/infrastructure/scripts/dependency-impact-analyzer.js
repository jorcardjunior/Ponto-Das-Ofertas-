...
/**
 * Dependency impact analyzer for Synkra Hefaisto framework
...
class DependencyImpactAnalyzer {
  ...
  extractDependenciesFromContent(content, filePath) {
    ...
    // Extract Hefaisto-specific references
  ...
  categorizeDependency(dep, dependencies, filePath) {
    ...
    } else if (dep.includes('hefaisto-core/') || dep.includes('/hefaisto-core/')) {
