...
/**
 * Component search utility for Synkra Hefaisto framework
...
class ComponentSearch {
  ...
  async searchComponent(componentType, componentName) {
    ...
    const searchPaths = [
      path.join(this.rootPath, 'hefaisto-core', typeConfig.directory),
  ...
  async findRegistrationFile(componentType, componentName) {
    const possibleRegistrationFiles = [
      path.join(this.rootPath, 'hefaisto-core', 'registry.json'),
