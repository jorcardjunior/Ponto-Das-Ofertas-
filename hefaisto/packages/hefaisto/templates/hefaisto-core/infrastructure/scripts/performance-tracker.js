...
function generateReport() {
  ...
  let report = `# Hefaisto Performance Report
...
`;
  ...
  report += '\n---\n\n*Auto-generated by Hefaisto Performance Tracker (Story 6.1.2.6)*\n';
 ...
 */
async function savePerformanceData(filepath = '.hefaisto-core/performance-data.json') {
  const data = {
    ...performanceData,
 ...
 */
async function loadPerformanceData(filepath = '.hefaisto-core/performance-data.json') {
  try {
