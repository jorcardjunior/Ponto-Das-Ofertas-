 ...
 *
 * Writes the current Hefaisto agent status to .hefaisto/dashboard/status.json
...
const STATUS_DIR = '.hefaisto/dashboard';
 ...
 * Uses Hefaisto_PROJECT_ROOT env var or cwd
 */
function getProjectRoot() {
  return process.env.Hefaisto_PROJECT_ROOT || process.cwd();
}
