...
Multi-provider AI integration for Hefaisto. Supports Claude Code and Gemini CLI with automatic fallback and task-based routing.
...
Create `.hefaisto-ai-config.yaml` in project root:
