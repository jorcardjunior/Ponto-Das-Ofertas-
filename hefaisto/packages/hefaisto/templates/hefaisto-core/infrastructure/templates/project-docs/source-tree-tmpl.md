...
> **Auto-generated by Hefaisto** on {{GENERATED_DATE}}
...
```
{{PROJECT_NAME}}/
├── .hefaisto-core/                    # Hefaisto configuration
...
|------|----------|---------|
| `.hefaisto-core/core-config.yaml` | Root | Hefaisto configuration |
...
*Generated by Hefaisto Documentation Integrity System*
