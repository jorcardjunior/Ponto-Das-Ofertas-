# Hefaisto Tools - Integrations Directory

This directory contains tool integration definitions for Synkra Hefaisto agents. Tools are external capabilities that agents can discover and use to accomplish tasks.
...
ls -la .hefaisto-core/tools/cli/
ls -la .hefaisto-core/tools/local/
ls -la .hefaisto-core/tools/mcp/

# Test tool resolver
node .hefaisto-core/infrastructure/scripts/tool-resolver.js
```
