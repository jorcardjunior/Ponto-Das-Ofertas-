 ...
 * and executes the defined task following Hefaisto methodology.
 *
...
class WorkflowOrchestrator {
  ...
  _resolveConfidenceThreshold(explicitThreshold) {
    ...
    const envThreshold = Number(process.env.Hefaisto_DELIVERY_CONFIDENCE_THRESHOLD);
