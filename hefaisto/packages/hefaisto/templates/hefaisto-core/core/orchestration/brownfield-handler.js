 ...
 *
 * Handles first execution behavior for existing projects without Hefaisto documentation.
...
class BrownfieldHandler extends EventEmitter {
  ...
  constructor(projectRoot, options = {}) {
    ...
    this.workflowPath = path.join(
      projectRoot,
      '.hefaisto-core/development/workflows/brownfield-discovery.yaml',
    );
      ...
      case PostDiscoveryChoice.RESOLVE_DEBTS:
        ...
        return {
          ...
          data: {
            ...
            taskPath: '.hefaisto-core/development/tasks/brownfield-create-epic.md',
            context,
          },
        };
