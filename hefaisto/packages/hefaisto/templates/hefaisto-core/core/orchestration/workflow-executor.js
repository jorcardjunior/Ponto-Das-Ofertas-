...
class WorkflowExecutor {
  ...
  constructor(projectRoot, options = {}) {
    ...
    this.workflowPath = path.join(
      projectRoot,
      '.hefaisto-core/development/workflows/development-cycle.yaml',
    );
    this.statePath = path.join(projectRoot, '.hefaisto/workflow-state/');
    this.configPath = path.join(projectRoot, '.hefaisto-core/core-config.yaml');
