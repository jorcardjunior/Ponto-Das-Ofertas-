 ...
 * - Session states older than 30 days (archived to .hefaisto/archive/sessions/)
...
const ARCHIVE_DIR = '.hefaisto/archive/sessions';
const SNAPSHOTS_DIR = '.hefaisto/snapshots';
...
class DataLifecycleManager {
   ...
   *
   * Sessions with last_updated > 30 days are moved to .hefaisto/archive/sessions/
   *
