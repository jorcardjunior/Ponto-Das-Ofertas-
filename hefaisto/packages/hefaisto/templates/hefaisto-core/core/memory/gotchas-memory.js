 ...
 *
 * Features:
 * - AC1: gotchas-memory.js in .hefaisto-core/core/memory/
 * - AC2: Persists in .hefaisto/gotchas.json and .hefaisto/gotchas.md
...
const CONFIG = {
  // Output paths
  gotchasJsonPath: '.hefaisto/gotchas.json',
  gotchasMdPath: '.hefaisto/gotchas.md',
  errorTrackingPath: '.hefaisto/error-tracking.json',
  ...
  // Version
  version: '1.0.0',
  schemaVersion: 'hefaisto-gotchas-memory-v1',
};
...
> Auto-generated by Hefaisto Gotchas Memory
> Last updated: ${now}
...
*Generated by Hefaisto Gotchas Memory v${CONFIG.version}*
`;
  ...
  static showHelp() {
    console.log(`
Gotchas Memory - Hefaisto Memory Layer (Story 9.4)
