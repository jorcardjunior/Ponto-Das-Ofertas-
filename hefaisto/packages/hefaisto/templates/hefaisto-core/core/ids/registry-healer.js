...
const HEALING_LOG_PATH = path.resolve(REPO_ROOT, '.hefaisto-core/data/registry-healing-log.jsonl');
const HEALING_BACKUP_DIR = path.resolve(REPO_ROOT, '.hefaisto-core/data/registry-backups/healing');
...
class RegistryHealer {
   ...
   * Integrates with Hefaisto NotificationManager (console + file channels).
   *
    ...
    switch (issue.ruleId) {
      ...
      default:
        return [
          ...
          'Run \'hefaisto ids:health --fix\' after resolving',
        ];
    }
  }
