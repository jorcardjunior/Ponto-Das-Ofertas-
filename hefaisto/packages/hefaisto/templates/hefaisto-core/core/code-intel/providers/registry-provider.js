 ...
 * Data source: .hefaisto-core/data/entity-registry.yaml (737+ entities, 14 categories).
 *
...
class RegistryProvider extends CodeIntelProvider {
  ...
  _resolveRegistryPath() {
    ...
    const defaultPath = path.join(projectRoot, '.hefaisto-core', 'data', 'entity-registry.yaml');
