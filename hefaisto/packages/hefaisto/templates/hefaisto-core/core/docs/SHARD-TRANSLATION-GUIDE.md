...
Synkra Hefaisto now automatically translates Portuguese documentation into English filenames when sharding documents. This ensures consistency across all projects and compatibility with hardcoded English filenames in configuration files.
...
**See full dictionary:** `.hefaisto-core/tasks/shard-doc.md` (Section 3)
...
**Configuration:** `.hefaisto-core/core-config.yaml`
...
```bash
# Check for issues
node .hefaisto-core/scripts/validate-filenames.js

# Auto-fix issues (renames files)
node .hefaisto-core/scripts/validate-filenames.js --fix
```
...
Edit `.hefaisto-core/tasks/shard-doc.md`, Section 3:
...
**Solution:**
1. Check you're using the updated `.hefaisto-core/tasks/shard-doc.md`
2. Run validator to confirm: `node .hefaisto-core/scripts/validate-filenames.js`
...
**Manual fix:**
Edit `.hefaisto-core/core-config.yaml` to add more fallbacks.
...
```javascript
// .hefaisto-core/scripts/validate-filenames.js
...
A: Edit `.hefaisto-core/tasks/shard-doc.md`, Section 3, and add to the YAML dictionary.
...
2. Run the validator: `node .hefaisto-core/scripts/validate-filenames.js`
3. Review `.hefaisto-core/tasks/shard-doc.md` for translation rules
