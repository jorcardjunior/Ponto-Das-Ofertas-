 ...
 *
 * Provides comprehensive health checking capabilities for Hefaisto projects.
 ...
 * The primary diagnostic interface is `hefaisto doctor` (bin/hefaisto.js → core/doctor/).
 * The agent-facing task `*health-check` now delegates to `hefaisto doctor --json`
 ...
 *
 * @module hefaisto-core/health-check
 * @version 1.0.0
