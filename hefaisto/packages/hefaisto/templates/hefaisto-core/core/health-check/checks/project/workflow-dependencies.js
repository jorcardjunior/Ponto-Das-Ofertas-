 ...
 *
 * @module hefaisto-core/health-check/checks/project/workflow-dependencies
 * @version 1.0.0
...
class WorkflowDependenciesCheck extends BaseCheck {
  constructor() {
    super({
      ...
      cacheable: true,
      healingTier: 0,
      tags: ['hefaisto', 'workflows', 'dependencies'],
    });
  }
  ...
  async execute(context) {
    ...
    const workflowPaths = [
      path.join(projectRoot, '.hefaisto-core', 'development', 'workflows'),
      path.join(projectRoot, '.hefaisto-core', 'infrastructure', 'workflows'),
    ];
    ...
    const taskPaths = [
      path.join(projectRoot, '.hefaisto-core', 'development', 'tasks'),
      path.join(projectRoot, '.hefaisto-core', 'infrastructure', 'tasks'),
    ];
