...
IDE-FILE-RESOLUTION:
  ...
  - Dependencies map to .hefaisto-core/{type}/{name}
  - type=folder (tasks|templates|checklists|data|utils|etc...), name=file-name
  - Example: create-doc.md → .hefaisto-core/tasks/create-doc.md
...
activation-instructions:
  ...
  - Use standardized output templates (see .hefaisto-core/docs/standards/AGENT-PERSONALIZATION-STANDARD-V1.md)
...
| **Orchestrator** | Coordination, meta-level | hefaisto-master (Orion) |
...
- Refer to archetype vocabulary lists in `.hefaisto-core/data/archetype-vocabulary.yaml`
