...
**Tasks:**
- `.hefaisto-core/tasks/{dependency1}.md`
- `.hefaisto-core/tasks/{dependency2}.md`

**Templates:**
- `.hefaisto-core/product/templates/{template1}.yaml`

**Checklists:**
- `.hefaisto-core/product/checklists/{checklist1}.md`
...
All task outputs MUST use this structure (see `.hefaisto-core/docs/standards/AGENT-PERSONALIZATION-STANDARD-V1.md`):
...
- See `.hefaisto-core/docs/standards/AGENT-PERSONALIZATION-STANDARD-V1.md` for complete guidelines
