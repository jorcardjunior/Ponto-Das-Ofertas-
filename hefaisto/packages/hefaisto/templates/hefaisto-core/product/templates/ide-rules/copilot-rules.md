# Synkra Hefaisto Agent for GitHub Copilot
...
3. Choose the Hefaisto agent mode you need

### Available Agent Modes
| Mode | Purpose |
|------|---------|
| hefaisto-dev | Full-stack development |
| hefaisto-qa | Quality assurance |
| hefaisto-architect | System design |
| hefaisto-pm | Project management |
...
---
*Synkra Hefaisto GitHub Copilot Configuration v4.0.4*
