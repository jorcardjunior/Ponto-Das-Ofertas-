# Synkra Hefaisto Development Rules for AntiGravity
...
### Agent Integration
- Recognize Hefaisto agent activations: @dev, @qa, @architect, @pm, @po, @sm, @analyst
...
---
*Synkra Hefaisto AntiGravity Configuration v1.0*
