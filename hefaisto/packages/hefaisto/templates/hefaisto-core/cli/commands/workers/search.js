 ...
 *
 * Implements `hefaisto workers search <query>` CLI command.
...
function createSearchCommand() {
  ...
  search
    ...
    .addHelpText('after', `
Examples:
  $ hefaisto workers search "json csv"
  $ hefaisto workers search "data transformation" --category=etl
  $ hefaisto workers search "validation" --tags=schema,json
  $ hefaisto workers search "api" --format=json --limit=5
  $ hefaisto workers search "transform" --semantic
  $ hefaisto workers search "convert" --keyword
`)
