...
Examples:
  $ hefaisto qa run                    Run full pipeline
  $ hefaisto qa run --layer=1          Run only Layer 1 (pre-commit)
  $ hefaisto qa run --layer=2          Run only Layer 2 (PR automation)
  $ hefaisto qa run --verbose          Run with detailed output
  $ hefaisto qa status                 Show current gate status
