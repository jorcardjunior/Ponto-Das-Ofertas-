...
//
// Usage:
//   node .hefaisto-core/data/mcp-discipline.js --apply     # Disable non-essential
//   node .hefaisto-core/data/mcp-discipline.js --restore   # Re-enable all
//   node .hefaisto-core/data/mcp-discipline.js --status    # Show current state
//   node .hefaisto-core/data/mcp-discipline.js --enable <server>  # Re-enable specific
// =============================================================================
...
const BACKUP_PATH = path.join(PROJECT_ROOT, '.hefaisto', 'mcp-backup.json');
const CAPABILITIES_PATH = path.join(PROJECT_ROOT, '.hefaisto', 'runtime-capabilities.json');
