# Hefaisto Health Dashboard

Visual dashboard for the Hefaisto Health Check System. Displays real-time health status, domain scores, issues, and self-healing history.
...
- **Production**: Reads from `.hefaisto/reports/health-check-latest.json`
...
- [Health Check Core Module](../../.hefaisto-core/core/health-check/)
- [JSON Reporter](../../.hefaisto-core/core/health-check/reporters/json.js)

---

_Part of Hefaisto-FULLSTACK - Story HCS-2 Phase 4_
