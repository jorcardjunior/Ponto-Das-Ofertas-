#!/usr/bin/env node
/**
 * Hefaisto-Core Installation Diagnostic Tool
 *
 * Run this script to diagnose installation issues:
 *   node diagnose-installation.js
 *
 * Or directly from URL:
 *   npx https://raw.githubusercontent.com/SynkraAI/hefaisto-core/main/tools/diagnose-installation.js
 */
...
console.log('');
console.log('╔══════════════════════════════════════════════════════════════════╗');
console.log('║          Hefaisto-Core Installation Diagnostic Tool                  ║');
console.log('╚══════════════════════════════════════════════════════════════════╝');
console.log('');
...
const pkgInfo = exec('npm view hefaisto-core version 2>&1');
if (pkgInfo && !pkgInfo.includes('E404') && !pkgInfo.includes('error')) {
  console.log(`  ✓ hefaisto-core v${pkgInfo} is available on npm`);
} else {
  console.log('  ⚠️  Cannot verify hefaisto-core package availability');
...
console.log('  Testing: npx hefaisto-core@latest --version');
const npxTest = exec('npx hefaisto-core@latest --version 2>&1');
...
if (hasErrors) {
  ...
  console.log('');
  console.log('You can install Hefaisto-Core with:');
  console.log('  npx hefaisto-core@latest');
  console.log('');
}
...
const summaryFile = path.join(os.tmpdir(), 'hefaisto-diagnostic-result.json');
