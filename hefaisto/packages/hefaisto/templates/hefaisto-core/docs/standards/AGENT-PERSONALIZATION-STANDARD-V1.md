...
│   (.hefaisto-core/agents/*.md)          │
└─────────────────────────────────────┘
              ↓
┌─────────────────────────────────────┐
│   LAYER 2: Output Formatter         │  ← Template engine (JS)
│   (.hefaisto-core/infrastructure/scripts/)│
└─────────────────────────────────────┘
              ↓
┌─────────────────────────────────────┐
...
```yaml
# .hefaisto-core/agents/{agent-id}.md
...
```yaml
# .hefaisto-core/data/archetype-vocabulary.yaml
...
```javascript
// .hefaisto-core/infrastructure/scripts/output-formatter.js
...
```javascript
// .hefaisto-core/infrastructure/scripts/validate-output-pattern.js
...
```markdown
<!-- .hefaisto-core/templates/task-execution-report.md -->
...
```markdown
<!-- .hefaisto-core/templates/agent-checklist-template.md -->
...
```yaml
# .hefaisto-core/workflows/{workflow-name}.yaml
...
11. Merge hefaisto-developer + hefaisto-orchestrator → hefaisto-master.md → Orion (Orchestrator)
