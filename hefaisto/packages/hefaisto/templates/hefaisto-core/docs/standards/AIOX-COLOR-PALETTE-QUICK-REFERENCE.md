# Hefaisto Color Palette - Quick Reference
...
```javascript
// Import the Hefaisto color system
const { colors, status, headings } = require('./src/utils/hefaisto-colors');

// Use in your code
console.log(headings.h1('Welcome to Hefaisto!'));
...
/* Use in your styles */
.button-primary {
  background: var(--hefaisto-primary);
}
```
...
### Welcome Screen
```javascript
console.log(headings.h1('🎉 Welcome to Hefaisto v4.2 Installer!'));
...
- **Complete Guide:** [Hefaisto-COLOR-PALETTE-V2.1.md](./Hefaisto-COLOR-PALETTE-V2.1.md)
- **Color Module:** `src/utils/hefaisto-colors.js`
