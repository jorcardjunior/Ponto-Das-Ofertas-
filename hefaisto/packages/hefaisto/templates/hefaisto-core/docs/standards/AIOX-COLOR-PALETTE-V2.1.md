# Hefaisto Color Palette v4.2

**Version:** 2.1.0  
**Created:** 2025-01-20  
**Status:** Active  
**Scope:** All Hefaisto CLI tools, installer, and visual outputs
...
The Hefaisto color palette is derived from the brand logo's vibrant gradient:
...
:root {
  /* Brand Colors */
  --hefaisto-primary: #8B5CF6;
  --hefaisto-secondary: #EC4899;
  --hefaisto-tertiary: #3B82F6;
  
  /* Functional Colors */
  --hefaisto-success: #10B981;
  --hefaisto-warning: #F59E0B;
  --hefaisto-error: #EF4444;
  --hefaisto-info: #06B6D4;
  
  /* Neutral Colors */
  --hefaisto-muted: #94A3B8;
  --hefaisto-dim: #64748B;
  
  /* Gradient */
  --hefaisto-gradient: linear-gradient(135deg, #EC4899 0%, #8B5CF6 50%, #3B82F6 100%);
}
```
...
- Use `colors.brandPrimary` (purple bold) for Hefaisto branding
- Example: Welcome screens, major section headers

```javascript
console.log(colors.brandPrimary('🎉 Hefaisto v4.2 Installer'));
```
...
// Success
console.log(colors.success('\n✓ All done! Your Hefaisto project is ready.\n'));
```
  ...
  "hefaisto": {
    "color": {
      "primary": {
        "$type": "color",
        "$value": "#8B5CF6",
        "$description": "Hefaisto primary brand color (ClickUp-inspired purple)"
      },
      "secondary": {
        "$type": "color",
        "$value": "#EC4899",
        "$description": "Hefaisto secondary brand color (magenta accent)"
      },
      "success": {
        "$type": "color",
        "$value": "#10B981",
    ...
    "gradient": {
      "brand": {
        ...
        "$description": "Hefaisto brand gradient (logo-inspired)"
      }
    }
  }
}
...
|---------|------|---------|--------|
| 2.1.0 | 2025-01-20 | Initial Hefaisto Color Palette - Logo-inspired gradient + ClickUp purple | Uma (UX-Design Expert) |

---

## 🔗 Related Documents

- [Hefaisto-LIVRO-DE-OURO-V2.1](./Hefaisto-LIVRO-DE-OURO-V2.1-SUMMARY.md) - Complete Hefaisto standards
