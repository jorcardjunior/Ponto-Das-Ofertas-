...
> Schema definitions for Hefaisto agents and tasks with Auto-Claude capabilities.
...
- **V2 (Legacy)**: Current Hefaisto format without `autoClaude` section
...
```bash
node validate-v3-schema.js .hefaisto-core/development/agents/dev.md
```
...
```bash
node validate-v3-schema.js --diff .hefaisto-core/development/agents/dev.md
```
...
```bash
node validate-v3-schema.js .hefaisto-core/development/agents/dev.md --strict
```
...
- PRD: `docs/prd/hefaisto-autonomous-development-engine.md`
- Auto-Claude Analysis: `docs/architecture/AUTO-CLAUDE-ANALYSIS-COMPLETE.md`
- Migration Stories: `docs/stories/hefaisto-core-ade/epic-2-migration-v2-v3.md`
...
_Hefaisto V3 Schemas - Synkra Framework_
